...
const UI = {
  sk: {
    ...
    policyText: "Palizra Analyzator sa zaväzuje k transparentnému opravovaniu chýb. Ak zistíme alebo dostaneme hlásenie o chybe v analýze, potvrdenú chybu opravíme do 5 pracovných dní od potvrdenia a zdokumentujeme opravu v tomto zázname. Opravené analýzy sú označené upozornením priamo v archíve.",
  ...
  en: {
    ...
    policyText: "Palizra Analyzator is committed to transparent error correction. If we identify or receive a report of an error in an analysis, we will correct confirmed errors within 5 business days of confirmation and document the correction in this record. Corrected analyses are flagged with a notice directly in the archive.",
  ...
  ar: {
    ...
    policyText: "يلتزم محلل بالزرا بتصحيح الأخطاء بشفافية. إذا اكتشفنا أو تلقينا تقريراً عن خطأ في تحليل ما، سنقوم بتصحيح الأخطاء المؤكدة خلال 5 أيام عمل من تأكيدها وتوثيق التصحيح في هذا السجل.",
  ...
  he: {
    ...
    policyText: "פליזרה אנלייזר מחויב לתיקון שגיאות בשקיפות. אם נזהה או נקבל דיווח על שגיאה בניתוח, נתקן שגיאות מאושרות בתוך 5 ימי עבודה מרגע האישור ונתעד את התיקון ברשומה זו.",
